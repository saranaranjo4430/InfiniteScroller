...
void UnitTests::Init(int width, int height)
{
...
void UnitTests::Update(float _deltaTime)
{
...
void UnitTests::MoveRect(float _deltaTime, const CController* _controller)
{
...
void UnitTests::MoveCircle(float _deltaTime, const CController* _controller)
{
...
void UnitTests::MoveSprite(float _deltaTime, const CController* _controller)
{
    float HSpeed = 0.75f * _deltaTime / 1000.f;
    float VSpeed = HSpeed * gameVp.GetRatio();
